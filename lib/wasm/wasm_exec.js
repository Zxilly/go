...
(() => {
	...
	globalThis.Go = class {
		constructor(options) {
			...
			// frame computes argument and result offsets in an ABI0 stack frame.
			// Arguments start after the 8-byte return-PC slot; results start at a
			// pointer-aligned offset. JavaScript references are 8-byte NaN-boxed
			// values in both ABIs.
