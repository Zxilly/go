...
var (
	genTypesFile      = flag.String("types", "simd/archsimd/types_wasmx.go", "output file for simd types (e.g. types_wasmx.go)")
	genOpsFile        = flag.String("ops", "simd/archsimd/ops_wasmx.go", "output file for simd ops (e.g. ops_wasmx.go)")
